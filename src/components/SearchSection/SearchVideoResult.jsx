      ...
      <div className={`flex-grow  overflow-y-auto ${isDarkMode ? "bg-gray-900 text-gray-300 " : "bg-white text-gray-800"}`}>
        <div className="p-4">
         {searchResult?.map((result)=>(
          <div key={result.id.videoId} className="flex flex-col md:flex-row mb-8">
             <Link to={`/video/${result.snippet.categoryId}/${result.id.videoId}`}>
             <img
             ...
             <div className="md:ml-4 md:w-2/3">
              ...
              <div className={`text-xm ${isDarkMode? "text-gray-400 ": "text-gray-600"}`}>
